...
//calculation of summation of left diagonal elements
for (int i = squareMatrix.GetLength(0) - 1, j = squareMatrix.GetLength(0) - 1; i >= 0; i--, j--)
{
    sumOfLeftDiag += squareMatrix[i, j];
}

//output answer
Console.WriteLine($"Sum of left diagonal: {sumOfLeftDiag}");
